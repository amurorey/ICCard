...
begin
  ...
  begin
    ...
    try
      ...
      ReturnQuery.ParamByName('PatientID').AsString := PatientIDTemp;
      ReturnQuery.ParamByName('Amount').AsFloat := PatientBaseQuery.FieldByname('PrepayMoney').AsFloat - StrToFloat(MoneyRzEdit.Text);
      ...
      ReturnQuery.ParamByName('Note').AsString := '-' + FloatToStr(StrToFloat(MoneyRzEdit.Text));
      ReturnQuery.ParamByName('Flag').AsInteger := 1;
      ReturnQuery.ParamByName('Kind').AsString := '退出预交金';
      ReturnQuery.Open;
      ...
      begin
        ...
        frxReport1.Variables['CardNo'] := '''' + PatientIDTemp + '''';
