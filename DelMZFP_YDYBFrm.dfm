object DelMZFP_YDYBForm: TDelMZFP_YDYBForm
  Left = 585
  Top = 337
  BorderStyle = bsDialog
  Caption = #21024#38500#38376#35786#21457#31080#65288#24322#22320#21307#20445#25509#21475#27169#24335#65289
  ClientHeight = 441
  ClientWidth = 581
  Color = clBtnFace
  ...
  object Panel1: TRzPanel
    ...
    object YBCardNumDBText: TDBText
      Left = 264
      Top = 26
      Width = 105
      Height = 13
  ...
  object YDYB_InvoicebaseQuery: TQuery
    DatabaseName = 'MZDATA'
    SQL.Strings = (
      'select * from ydyb_invoicebase (nolock)'
  ...
  object SaveMZFP_YDYBStoredProc: TStoredProc
    DatabaseName = 'MZDATA'
    StoredProcName = 'dbo.SaveMZFP_YDYB'
    Left = 208
    Top = 16
    ParamData = <
      item
  ...
  object MZCFInfQuery: TQuery
    SQL.Strings = (
      
        'select fpnum from mzcfinf (nolock) where fpnum=:fpnum and fydate' +
        ' is not null')
    Left = 360
    Top = 184
    ParamData = <
  ...
  object YJ_ApplySheetQuery: TQuery
    SQL.Strings = (
      'select applynum from yj_applysheet (nolock)'
      '  where fpnum=:fpnum and yjcheckdate is not null')
    Left = 392
    Top = 184
    ParamData = <
      item
