object AddPatientbase_specialForm: TAddPatientbase_specialForm
  Left = 366
  Top = 312
  BorderStyle = bsDialog
  Caption = #26032#22686#32511#33394#36890#36947#24739#32773'ID'
  ClientHeight = 255
  ClientWidth = 465
  Color = clBtnFace
  ...
  object RzPanel1: TRzPanel
    ...
    object SexComboBox: TRzComboBox
      Left = 96
      Top = 68
      Width = 121
      Height = 23
  ...
  object AddQuery: TQuery
    SQL.Strings = (
        ...
        'insert patientbase(patientid,patientname,sex,opername,operdate,n' +
        'ote,specialflag,CreateDate)'
      
        '    values(:patientid,:patientname,:sex,:opername,getdate(),:not' +
        'e,1,getdate())')
    Left = 24
    Top = 16
    ParamData = <
