object SearchYWZQIDForm: TSearchYWZQIDForm
  Left = 192
  Top = 114
  BorderStyle = bsDialog
  Caption = #26597#35810#19994#21153#21608#26399#21495
  ClientHeight = 304
  ClientWidth = 442
  Color = clBtnFace
  ...
  object RzDBGrid1: TRzDBGrid
    ...
    Columns = <
      item
        ...
        Title.Caption = #19994#21153#31867#21035
        Width = 60
        Visible = True
      end
      item
        Expanded = False
        FieldName = 'FPOperName'
        Title.Alignment = taCenter
      ...
      item
        ...
        FieldName = 'YWZQID'
        Title.Alignment = taCenter
        Title.Caption = #19994#21153#21608#26399#21495
        Width = 196
        Visible = True
      end>
  end
  ...
  object XNH_InvoicebaseQuery: TQuery
    SQL.Strings = (
      'select case when PatientState=1 then '#39#38376#35786#39' else '#39#20303#38498#39' end as YWLB,'
      '          FPOperCode,FPOperName,YWZQID '
      '  from xnh_invoicebase (nolock) '
      '  where fpdate>=:begdate and fpdate<:enddate'
      'group by PatientState,FPOperCode,FPOperName,YWZQID'
      'order by fpopercode')
    Left = 8
    ParamData = <
      item
