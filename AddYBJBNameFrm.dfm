object AddYBJBNameForm: TAddYBJBNameForm
  Left = 291
  Top = 378
  BorderStyle = bsDialog
  Caption = #20303#38498#30149#20154#20854#23427#35786#26029
  ClientHeight = 352
  ClientWidth = 834
  Color = clBtnFace
  ...
  object RzLabel1: TRzLabel
    ...
    Width = 91
    Height = 13
    Caption = #35831#36755#20837#26597#35810#23383#31526
    Font.Charset = GB2312_CHARSET
    Font.Color = clWindowText
    Font.Height = -13
    Font.Name = #23435#20307
  ...
  object RzLabel2: TRzLabel
    ...
    Width = 126
    Height = 14
    Caption = #35813#30149#20154#20303#38498#20854#23427#35786#26029
    BlinkIntervalOff = 1000
    BlinkIntervalOn = 1000
  end
  object JBNameListBox: TRzListBox
    Left = 464
    Top = 48
    Width = 337
    Height = 249
  ...
  object YB_JBCodeQuery: TQuery
    DatabaseName = 'CRYData'
    SQL.Strings = (
      'select * from yb_jbcode (nolock)'
      
        '  where (jbcode like :strval or jbname like :strval or pym like ' +
        ':strval)')
    Left = 48
    Top = 56
    ParamData = <
  ...
  object DataSource1: TDataSource
    DataSet = YB_JBCodeQuery
    Left = 80
    Top = 56
  end
  object FirstJBCodeQuery: TQuery
    DatabaseName = 'CRYData'
    SQL.Strings = (
      'select * from yb_jbcode (nolock)'
      '  where jbname=:strval')
